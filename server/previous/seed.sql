...
INSERT INTO festival_api_second (festivalId, overview, url)
VALUES (
    2709958,
    "사계절 내내 아름다운 자연이 가득한 숲과 정원 가산수피아!! 설레는 봄, 봄꽃 향기 가득한 정원과 레일썰매, 수피아미술관, 배틀그라운드 등  감성지수를 높이고 스트레스를 낮출 체험이 이 곳엔 가득하다. 3월 중순부터 4월 중순까지 한달간 진행되는 '봄의 정원'은 벚꽃, 꽃잔디, 연산홍, 목련 등 다양한 꽃들의 향기가 봄을 전하고,  공룡뜰, 벚꽃길, 천년솔숲 황토길, 이끼정원, 테마정원 등 잊고 살던 감성의 소리를 색, 향, 촉감으로 만끽할 수 있는 시간이 될 것이다.",
...
신비한 빛깔과 아름다운 무늬가 특징인 고려청자는 한국을 대표하는 도자예술품이다. 약 500년 간 청자문화를 꽃피웠던 청자의 고장 강진에서 고려청자와 도자예술을 제주로 한 강진청자축제가 열린다. 화목가마 불 지피기부터 물레 성형하기, 청자 상감하기, 청자 조각하기 등 직접 청자를 제작하는 과정을 체험해볼 수 있다. 체험을 하는 과정에서 강진청자의 아름다움과 섬세함, 그리고 뛰어난 가치에 대해 느껴볼 수 있다. <br><br>[축제TIP] 고려청자란?<br>고려청자는 한국문화예술사에서 가장 자랑할만한 것 중의 하나라고 할 수 있는 우리나라의 대표적인 도자예술품으로 비색상감무늬는 기술과 아름다움의 극치로 표현되고 있으며 인공을 떠난 천공의 경지라는 찬사를 받고 있다.",
  ...
  ) -- mysql -u admin --host local-festival-db.c5uujgrdfrvu.ap-northeast-2.rds.amazonaws.com -P 3306 -p < seed.sql -p -Dlocal_festival