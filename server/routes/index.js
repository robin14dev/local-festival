...
//      //console.log("addpick",req.body); //{ festivalId: 4 }
//    res.send("good")
//      // 받아온 user_id와 festivalId로 데이터 저장해주세욥
...
//      const dummydata = [{festivalId : 3},{festivalId : 4}, {festivalId:5}]
...
//      //console.log('deletepick',req.body); //delete { user_id: 1, festivalId: 11 }
//      // db에 삭제 처리 해주세욥
//      res.send("good")
//    })
   ...
   router.post('/review', (req, res)=>{
     ...
     console.log(req.body);
       ...
       // { data: { content: 'ㄹㄷㄹㄷ', rating: 3, festivalId: 4 } }
   ...
   router.get('/review/:festivalId', (req, res) => {
     //console.log(req.params);
     // { festivalId: '4' } 특정 행사의 아이디가 string으로 들어옵니다 (주의)
   ...
   router.delete('/review/:id', (req, res) => {
     // id는 review table의 고유 id(pk) 입니다. api문서에 festivalId랑 user_id 요렇게 보내주기로 되어있는데
     // user_id는 토큰에 이미 담겨져서 오므로 토큰 검증으로 user_id를 얻을 수 있어 client에서 보내줄 필요가 없고, user_id랑 festivalId로 조인해서 찾는거보다 review table의 고유아이디를 프론트에서 백으로 바로 보내주어 백에서 더 간편하게 review table만 조회하여 삭제할 수 있습니다.
